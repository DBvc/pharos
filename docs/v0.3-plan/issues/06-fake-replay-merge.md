# Fake replay and merge identity

## Objective

Add fixture replay, source-signal endpoint, identity table, and no-duplicate active requests.

## Instructions

Use `codex/06_FAKE_ADAPTER_REPLAY_AND_MERGE_IDENTITY.md` as the exact execution prompt. Also provide `codex/00_MASTER_RULES.md` in the same Codex session.
