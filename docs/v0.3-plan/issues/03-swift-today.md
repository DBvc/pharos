# Swift Today decision cockpit

## Objective

Update Swift models and TodayView to consume DecisionCard groups.

## Instructions

Use `codex/03_SWIFT_TODAY_DECISION_COCKPIT.md` as the exact execution prompt. Also provide `codex/00_MASTER_RULES.md` in the same Codex session.
