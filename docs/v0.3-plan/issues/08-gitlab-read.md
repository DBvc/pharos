...
Add read-only GitLab MR sync with fixtures and parser tests.

## Instructions

Use `codex/08_GITLAB_READ_ONLY_ADAPTER.md` as the exact execution prompt. Also provide `codex/00_MASTER_RULES.md` in the same Codex session.
