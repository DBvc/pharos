# Controlled GitLab writeback

## Objective

Add approved GitLab comment writeback through core policy.

## Instructions

Use `codex/10_CONTROLLED_GITLAB_WRITEBACK.md` as the exact execution prompt. Also provide `codex/00_MASTER_RULES.md` in the same Codex session.
