...
Add metrics API/export and dogfood readiness.

## Instructions

Use `codex/11_METRICS_DOGFOOD.md` as the exact execution prompt. Also provide `codex/00_MASTER_RULES.md` in the same Codex session.
