# Request Detail judgment view

## Objective

Reorganize Request Detail around the four decision questions.

## Instructions

Use `codex/04_REQUEST_DETAIL_JUDGMENT_VIEW.md` as the exact execution prompt. Also provide `codex/00_MASTER_RULES.md` in the same Codex session.
