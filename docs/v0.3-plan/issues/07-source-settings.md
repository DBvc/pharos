...
Add persistent source settings API and Swift shell.

## Instructions

Use `codex/07_SOURCE_SETTINGS_SHELL.md` as the exact execution prompt. Also provide `codex/00_MASTER_RULES.md` in the same Codex session.
